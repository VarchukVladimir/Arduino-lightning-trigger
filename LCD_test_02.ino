...
#define DEFAULT_LONG_EXP_TIME  10
//define pins
...
//define modes
#define modeBULB_A        4
#define modeFAST_SHOOT_B  3
#define modeBULB_C        2
#define modeLongEXP_D     1
//
#define MAX_LINE  50
...
void LCD_print_screen()
{
  ...
  switch (mainMenuItem)
  {
    case mSetMode:
      {
        ...
        switch (shootingMode)
        {
          ...
          case modeLongEXP_D:
            {
              snprintf(Line_2, max_line, "D.Long EXP");
              break;
            }
        }
        break;
    ...
    case mSetExpD:
      {
        pout("ECXP");
        snprintf(Line_1, max_line, "    Long exp D");
        snprintf(Line_2, max_line, "%d (minutes)", expD);
        break;
      }
    case mReset:
      {
...
void LCD_print_working_screen()
{
  ...
  switch (shootingMode)
  {
    ...
    case modeLongEXP_D:
      {
        snprintf(Line_1, max_line, "D.Long EXP");
        snprintf(Line_2, max_line, "Int %d minutes", expD);
        break;
      }
  }
  lcd.clear();
      ...
      case btnUP:
        {
          ...
          switch (mainMenuItem)
          {
            ...
            case mSetExpD:
              {
                expD = inc_menu(expD, 30, 1, select_status);
                break;
              }
          }
          break;
